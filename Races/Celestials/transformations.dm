	...
	celestial
		...
		Celestial_Devil_Trigger
			...
			mastery_boons(mob/user)
				if(mastery >= 25)
					passives = list("GodKi" = 0.15, "HellPower" = 0.25, "HellRisen" = 0.5, "DemonicDurability" = 4, "Brutalize" = 4, "PureDamage" = 3, "PureReduction" = 3, "Smokin'!" = 1)
				if(mastery >= 50)
					passives = list("GodKi" = 0.35, "HellPower" = 0.5, "HellRisen" = 0.75, "DemonicDurability" = 6, "Brutalize" = 5, "PureDamage" = 5, "PureReduction" = 5, "MovementMastery" = 3, "BuffMastery"= 3, "Smokin'!" = 1)
				if(mastery >= 75)
					passives = list("GodKi" = 0.5, "HellPower" = 0.75, "HellRisen" = 0.75, "DemonicDurability" = 6, "Brutalize" = 6, "PureDamage" = 6, "PureReduction" = 6, "MovementMastery" = 6, "TechniqueMastery" = 3, "Steady" = 3, "BuffMastery"= 6, "Smokin'!" = 1)
				if(mastery >= 100)
