...
/obj/Skills/Buffs/SlotlessBuffs/Autonomous/HellbornFury/Stage_One
	...
	adjust(mob/p)
		if(altered) return
		passives = list("CalmAnger" = 1, "Instinct" = 2, "PureDamage" = 2, "Perseverence" = p.AscensionsAcquired/2\
...
/obj/Skills/Buffs/SlotlessBuffs/Autonomous/HellbornFury/Stage_Two
	...
	adjust(mob/p)
		...
		passives = list("CalmAnger" = 1, \
						"LikeWater" = 2 + round(p.Potential/25,1), "Flicker" = 1, "Pursuer" = 1, "PureDamage" = 2, "PureReduction" = 1, "HellPower" = 0.15, "Perseverence" = p.AscensionsAcquired\
...
/obj/Skills/Buffs/SlotlessBuffs/Autonomous/HellbornFury/Stage_Three
	...
	adjust(mob/p)
		...
		passives = list("CalmAnger" = 1, "BleedHit"=0.25,"PureReduction" = 2, \
						"LikeWater" = 2 + round(p.Potential/20,1),"SlayerMod"= 0.5*(p.AscensionsAcquired+1), "HellPower" = 0.4, "Perseverence" = p.AscensionsAcquired\
