...
obj/Items/Magatama/Wadatsumi
	...
	passive_scaling = list("ManaCapMult" = 0.008, "ChillResist" = 0.04, "WaterSpellDamage" = 0.0075, "Chilling" = 0.1, "WaterSpellCooldown" = 0.007, "WaterSpellManaCost" = 0.007)
...
obj/Items/Magatama/Ankh
	...
	base_passives = list("Godspeed" = 1, "GoodResist" = 1, "LifeGeneration" = 1, "LightSpellDamage" = 0.2, "HolyMod" = 2)
...
obj/Items/Magatama/Iyomante
	...
	passive_scaling = list("LifeGeneration" = 0.04, "ManaGeneration" = 0.04, "ManaStats" = 0.05, "Confusing" = 0.25, "Disarm" = 0.02, "ControlResist" = 0.04, "Unnerve" = 0.04)
...
obj/Items/Magatama/Shiranui
	...
	passive_scaling = list("FireSpellDamage" = 0.0075, "BurnResist" = 0.04, "Burning" = 0.1, "Combustion" = 0.75, "SpiritHand" = 0.06, "FireSpellCooldown" = 0.007, "FireSpellManaCost" = 0.007)
...
obj/Items/Magatama/Hifumi
	...
	passive_scaling = list("AirSpellDamage" = 0.0075, "ShearResist" = 0.04, "BlurringStrikes" = 0.04, "AttackSpeed" = 0.008, "AirSpellCooldown" = 0.007, "AirSpellManaCost" = 0.007, "QuickCast" = 0.04)
...
obj/Items/Magatama/Kamudo
	...
	passive_scaling = list("Brutalize" = 0.05, "KillerInstinct" = 0.01, "CriticalChance" = 0.25, "Steady" = 0.09, "MeleeResist" = 0.04, "CriticalDamage" = 0.0045, "UnarmedDamage" = 0.09)
...
obj/Items/Magatama/Narukami
	...
	passive_scaling = list("AirSpellDamage" = 0.0085, "ShockResist" = 0.04, "Shocking" = 0.15, "Denko Sekka" = 0.05, "AirSpellCooldown" = 0.007, "AirSpellManaCost" = 0.007)
...
obj/Items/Magatama/Anathema
	...
	passive_scaling = list("EvilResist" = 0.04, "Terrifying" = 0.1, "DarkSpellDamage" = 0.0075, "AbyssMod" = 0.08, "DarkSpellCooldown" = 0.007, "DarkSpellManaCost" = 0.007)
...
obj/Items/Magatama/Miasma
	...
	passive_scaling = list("ChillResist" = 0.03, "ChillAbsorb" = 0.075, "WaterSpellCooldown" = 0.006, "WaterSpellManaCost" = 0.006, "WaterSpellDamage" = 0.008)
...
obj/Items/Magatama/Nirvana
	...
	passive_scaling = list("GoodResist" = 0.04, "HolyMod" = 0.08, "LightSpellDamage" = 0.008, "LifeGeneration" = 0.045)
...
obj/Items/Magatama/Murakumo
	...
	ascension_passives = list("6" = list("BurnResist" = 1, "ChillResist" = 1, "ShearResist" = 1))
...
obj/Items/Magatama/Geis
	...
	passive_scaling = list("LifeGeneration" = 0.04, "ManaGeneration" = 0.1, "LifeSteal" = 0.3, "Godspeed" = 0.08, "ManaCapMult" = 0.008, "GoodResist" = 0.04)
	ascension_passives = list("4" = list("AngelicInfusion" = 1))
...
obj/Items/Magatama/Muspell
	...
	passive_scaling = list("Brutalize" = 0.05, "Confusing" = 0.25, "Harden" = 0.09, "BurnResist" = 0.04, "CrippleResist" = 0.04, "Disarm" = 0.02, "ControlResist" = 0.04)
	ascension_passives = list("4" = list("ControlResist" = 1))
...
obj/Items/Magatama/Gehenna
	...
	passive_scaling = list("BurnResist" = 0.04, "ManaCapMult" = 0.0075, "FireAbsorb" = 0.0075, "FireSpellManaCost" = 0.006, "FireSpellCooldown" = 0.006, "FireSpellDamage" = 0.008, "Burning" = 0.15)
...
obj/Items/Magatama/Kamurogi
	...
	passive_scaling = list("LifeGeneration" = 0.04, "CounterMaster" = 0.1, "Steady" = 0.09, "Harden" = 0.09, "SwordDamage" = 0.09, "AttackSpeed" = 0.008, "LikeWater" = 0.04)
	ascension_passives = list("6" = list("Steady" = 1, "Harden" = 1))
...
obj/Items/Magatama/Adama
	...
	passive_scaling = list("AirSpellDamage" = 0.008, "ManaCapMult" = 0.0065, "ShockAbsorb" = 0.02, "Denko Sekka" = 0.05, "AirSpellCooldown" = 0.006, "AirSpellManaCost" = 0.006, "ShockResist" = 0.04, "Shocking" = 0.15)
...
obj/Items/Magatama/Vimana
	...
	passive_scaling = list("Harden" = 0.09, "BlockChance" = 0.2, "CriticalBlock" = 0.0075, "Tenacity" = 0.075, "PhysPleroma" = 0.04, "MeleeResist" = 0.04, "Steady" = 0.09, "AttackSpeed" = 0.008)
...
obj/Items/Magatama/Gundari
	...
	passive_scaling = list("AirSpellDamage" = 0.008, "ShearResist" = 0.04, "WindAbsorb" = 0.02, "QuickCast" = 0.04, "AirSpellCooldown" = 0.007, "AirSpellManaCost" = 0.007)
...
obj/Items/Magatama/Kailash
	...
	base_passives = list("Harden" = 2, "Steady" = 2, "MeleeResist" = 1, "LifeGeneration" = 1, "Brutalize" = 2, "PowerfulCasting" = 0.5, "Vortex" = 5, "Entropic" = 0.5)
	passive_scaling = list("Harden" = 0.08, "Steady" = 0.08, "MeleeResist" = 0.04, "LifeGeneration" = 0.03, "Brutalize" = 0.1, "KillerInstinct" = 0.01, "PowerfulCasting" = 0.015, "Vortex" = 0.2, "Entropic" = 0.035)
